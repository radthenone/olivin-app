...
export const getCustomersAddressesCreateMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof customersAddressesCreate>>, TError,{data?: BodyType<NonReadonly<Address>>}, TContext>, request?: SecondParameter<typeof appInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof customersAddressesCreate>>, {data?: BodyType<NonReadonly<Address>>}> = (props) => {
          ...
          return  customersAddressesCreate(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CustomersAddressesCreateMutationBody = BodyType<NonReadonly<Address>> | undefined
...
export const getCustomersAddressesRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof customersAddressesRetrieve>>, TError = ErrorType<unknown>>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof customersAddressesRetrieve>>, TError, TData>>, request?: SecondParameter<typeof appInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getCustomersAddressesRetrieveQueryKey(id);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof customersAddressesRetrieve>>> = ({ signal }) => customersAddressesRetrieve(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof customersAddressesRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useCustomersAddressesRetrieve<TData = Awaited<ReturnType<typeof customersAddressesRetrieve>>, TError = ErrorType<unknown>>(
 id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof customersAddressesRetrieve>>, TError, TData>>, request?: SecondParameter<typeof appInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getCustomersAddressesUpdateMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof customersAddressesUpdate>>, TError,{id: string;data?: BodyType<NonReadonly<Address>>}, TContext>, request?: SecondParameter<typeof appInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof customersAddressesUpdate>>, {id: string;data?: BodyType<NonReadonly<Address>>}> = (props) => {
          ...
          return  customersAddressesUpdate(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CustomersAddressesUpdateMutationBody = BodyType<NonReadonly<Address>> | undefined
...
export const customersAddressesPartialUpdate = async (id: string,
  ...
  return appInstance<customersAddressesPartialUpdateResponse>(getCustomersAddressesPartialUpdateUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patchedAddress)
  }
);}
...
export const getCustomersAddressesPartialUpdateMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof customersAddressesPartialUpdate>>, TError,{id: string;data?: BodyType<NonReadonly<PatchedAddress>>}, TContext>, request?: SecondParameter<typeof appInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof customersAddressesPartialUpdate>>, {id: string;data?: BodyType<NonReadonly<PatchedAddress>>}> = (props) => {
          ...
          return  customersAddressesPartialUpdate(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CustomersAddressesPartialUpdateMutationBody = BodyType<NonReadonly<PatchedAddress>> | undefined
...
export const getCustomersAddressesDestroyMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof customersAddressesDestroy>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof appInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof customersAddressesDestroy>>, {id: string}> = (props) => {
          ...
          return  customersAddressesDestroy(id,requestOptions)
        }
...
export const getCustomersAddressesSetDefaultPartialUpdateMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof customersAddressesSetDefaultPartialUpdate>>, TError,{id: string;data?: BodyType<NonReadonly<PatchedAddress>>}, TContext>, request?: SecondParameter<typeof appInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof customersAddressesSetDefaultPartialUpdate>>, {id: string;data?: BodyType<NonReadonly<PatchedAddress>>}> = (props) => {
          ...
          return  customersAddressesSetDefaultPartialUpdate(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CustomersAddressesSetDefaultPartialUpdateMutationBody = BodyType<NonReadonly<PatchedAddress>> | undefined
