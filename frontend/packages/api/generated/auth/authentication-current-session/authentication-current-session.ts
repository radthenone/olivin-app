...
import type { ErrorType } from '../../../src/auth-mutator';
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthSessionQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>> = ({ signal }) => getAllauthClientV1AuthSession(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthSession<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError = ErrorType<AuthenticationResponse | SessionGoneResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get authentication status
...
export const getDeleteAllauthClientV1AuthSessionMutationOptions = <TError = ErrorType<UnauthenticatedResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AuthSession>>, TError,{client: 'app' | 'browser'}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const useDeleteAllauthClientV1AuthSession = <TError = ErrorType<UnauthenticatedResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteAllauthClientV1AuthSessionMutationOptions(options), queryClient);
    }
