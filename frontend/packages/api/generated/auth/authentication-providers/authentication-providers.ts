...
export const getPostAllauthBrowserV1AuthProviderRedirectMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>, TError,{data: BodyType<ProviderRedirectBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const usePostAllauthBrowserV1AuthProviderRedirect = <TError = ErrorType<void>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthBrowserV1AuthProviderRedirectMutationOptions(options), queryClient);
    }
...
export const getPostAllauthClientV1AuthProviderTokenMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderTokenBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const usePostAllauthClientV1AuthProviderToken = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthProviderTokenMutationOptions(options), queryClient);
    }
...
export const getGetAllauthClientV1AuthProviderSignupQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError = ErrorType<ConflictResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthProviderSignupQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>> = ({ signal }) => getAllauthClientV1AuthProviderSignup(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthProviderSignup<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError = ErrorType<ConflictResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Provider signup information
...
export const getPostAllauthClientV1AuthProviderSignupMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderSignupBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const usePostAllauthClientV1AuthProviderSignup = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse | ConflictResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthProviderSignupMutationOptions(options), queryClient);
    }
