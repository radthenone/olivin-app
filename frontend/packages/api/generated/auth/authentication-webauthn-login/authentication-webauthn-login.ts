...
import { authInstance } from '../../../src/auth-mutator';
import type { ErrorType , BodyType } from '../../../src/auth-mutator';
...
export type getAllauthClientV1AuthWebauthnAuthenticateResponse200 = {
  data: WebAuthnRequestOptionsResponseResponse
  status: 200
}

export type getAllauthClientV1AuthWebauthnAuthenticateResponseSuccess = (getAllauthClientV1AuthWebauthnAuthenticateResponse200) & {
  headers: Headers;
};
;

export type getAllauthClientV1AuthWebauthnAuthenticateResponse = (getAllauthClientV1AuthWebauthnAuthenticateResponseSuccess)

export const getGetAllauthClientV1AuthWebauthnAuthenticateUrl = (client: 'app' | 'browser',) => {




  return `/_allauth/${client}/v1/auth/webauthn/authenticate`
}
 ...
 */
export const getAllauthClientV1AuthWebauthnAuthenticate = async (client: 'app' | 'browser', options?: RequestInit): Promise<getAllauthClientV1AuthWebauthnAuthenticateResponse> => {

  return authInstance<getAllauthClientV1AuthWebauthnAuthenticateResponse>(getGetAllauthClientV1AuthWebauthnAuthenticateUrl(client),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthWebauthnAuthenticateQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnAuthenticate>>> = ({ signal }) => getAllauthClientV1AuthWebauthnAuthenticate(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnAuthenticate>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthWebauthnAuthenticate<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnAuthenticate>>, TError = ErrorType<unknown>>(
...
export function useGetAllauthClientV1AuthWebauthnAuthenticate<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnAuthenticate>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnAuthenticate>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get WebAuthn credential request options for 2FA
...
export type postAllauthClientV1AuthWebauthnAuthenticateResponse200 = {
  data: AuthenticatedResponse
  status: 200
}

export type postAllauthClientV1AuthWebauthnAuthenticateResponse400 = {
  data: ErrorResponse
  status: 400
}

export type postAllauthClientV1AuthWebauthnAuthenticateResponseSuccess = (postAllauthClientV1AuthWebauthnAuthenticateResponse200) & {
  headers: Headers;
};
export type postAllauthClientV1AuthWebauthnAuthenticateResponseError = (postAllauthClientV1AuthWebauthnAuthenticateResponse400) & {
  headers: Headers;
};

export type postAllauthClientV1AuthWebauthnAuthenticateResponse = (postAllauthClientV1AuthWebauthnAuthenticateResponseSuccess | postAllauthClientV1AuthWebauthnAuthenticateResponseError)

export const getPostAllauthClientV1AuthWebauthnAuthenticateUrl = (client: 'app' | 'browser',) => {
 ...
 */
export const postAllauthClientV1AuthWebauthnAuthenticate = async (client: 'app' | 'browser',
    authenticateWebAuthnBody: AuthenticateWebAuthnBody, options?: RequestInit): Promise<postAllauthClientV1AuthWebauthnAuthenticateResponse> => {

  return authInstance<postAllauthClientV1AuthWebauthnAuthenticateResponse>(getPostAllauthClientV1AuthWebauthnAuthenticateUrl(client),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(authenticateWebAuthnBody)
  }
);}
...
export const getPostAllauthClientV1AuthWebauthnAuthenticateMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<AuthenticateWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<AuthenticateWebAuthnBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnAuthenticate>>, {client: 'app' | 'browser';data: BodyType<AuthenticateWebAuthnBody>}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthWebauthnAuthenticateMutationBody = BodyType<AuthenticateWebAuthnBody>
    export type PostAllauthClientV1AuthWebauthnAuthenticateMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Perform 2FA using WebAuthn
 */
export const usePostAllauthClientV1AuthWebauthnAuthenticate = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<AuthenticateWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthWebauthnAuthenticateMutationOptions(options), queryClient);
    }
    export type getAllauthClientV1AuthWebauthnReauthenticateResponse200 = {
  data: WebAuthnRequestOptionsResponseResponse
  status: 200
}

export type getAllauthClientV1AuthWebauthnReauthenticateResponseSuccess = (getAllauthClientV1AuthWebauthnReauthenticateResponse200) & {
  headers: Headers;
};
;

export type getAllauthClientV1AuthWebauthnReauthenticateResponse = (getAllauthClientV1AuthWebauthnReauthenticateResponseSuccess)

export const getGetAllauthClientV1AuthWebauthnReauthenticateUrl = (client: 'app' | 'browser',) => {




  return `/_allauth/${client}/v1/auth/webauthn/reauthenticate`
}
 ...
 */
export const getAllauthClientV1AuthWebauthnReauthenticate = async (client: 'app' | 'browser', options?: RequestInit): Promise<getAllauthClientV1AuthWebauthnReauthenticateResponse> => {

  return authInstance<getAllauthClientV1AuthWebauthnReauthenticateResponse>(getGetAllauthClientV1AuthWebauthnReauthenticateUrl(client),
  {
    ...options,
    method: 'GET'
...
export const getGetAllauthClientV1AuthWebauthnReauthenticateQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthWebauthnReauthenticateQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>> = ({ signal }) => getAllauthClientV1AuthWebauthnReauthenticate(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthWebauthnReauthenticate<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError = ErrorType<unknown>>(
...
export function useGetAllauthClientV1AuthWebauthnReauthenticate<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnReauthenticate>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get WebAuthn credential request options for reauthentication
...
export type postAllauthClientV1AuthWebauthnReauthenticateResponse200 = {
  data: AuthenticatedResponse
  status: 200
}

export type postAllauthClientV1AuthWebauthnReauthenticateResponse400 = {
  data: ErrorResponse
  status: 400
}

export type postAllauthClientV1AuthWebauthnReauthenticateResponseSuccess = (postAllauthClientV1AuthWebauthnReauthenticateResponse200) & {
  headers: Headers;
};
export type postAllauthClientV1AuthWebauthnReauthenticateResponseError = (postAllauthClientV1AuthWebauthnReauthenticateResponse400) & {
  headers: Headers;
};

export type postAllauthClientV1AuthWebauthnReauthenticateResponse = (postAllauthClientV1AuthWebauthnReauthenticateResponseSuccess | postAllauthClientV1AuthWebauthnReauthenticateResponseError)

export const getPostAllauthClientV1AuthWebauthnReauthenticateUrl = (client: 'app' | 'browser',) => {
 ...
 */
export const postAllauthClientV1AuthWebauthnReauthenticate = async (client: 'app' | 'browser',
    reauthenticateWebAuthnBody: ReauthenticateWebAuthnBody, options?: RequestInit): Promise<postAllauthClientV1AuthWebauthnReauthenticateResponse> => {

  return authInstance<postAllauthClientV1AuthWebauthnReauthenticateResponse>(getPostAllauthClientV1AuthWebauthnReauthenticateUrl(client),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(reauthenticateWebAuthnBody)
  }
);}
...
export const getPostAllauthClientV1AuthWebauthnReauthenticateMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<ReauthenticateWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<ReauthenticateWebAuthnBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnReauthenticate>>, {client: 'app' | 'browser';data: BodyType<ReauthenticateWebAuthnBody>}> = (props) => {
          const {client,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthWebauthnReauthenticateMutationBody = BodyType<ReauthenticateWebAuthnBody>
    export type PostAllauthClientV1AuthWebauthnReauthenticateMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Reauthenticate using WebAuthn
 */
export const usePostAllauthClientV1AuthWebauthnReauthenticate = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<ReauthenticateWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthWebauthnReauthenticateMutationOptions(options), queryClient);
    }
    export type getAllauthClientV1AuthWebauthnLoginResponse200 = {
  data: WebAuthnRequestOptionsResponseResponse
  status: 200
}

export type getAllauthClientV1AuthWebauthnLoginResponseSuccess = (getAllauthClientV1AuthWebauthnLoginResponse200) & {
  headers: Headers;
};
;

export type getAllauthClientV1AuthWebauthnLoginResponse = (getAllauthClientV1AuthWebauthnLoginResponseSuccess)

export const getGetAllauthClientV1AuthWebauthnLoginUrl = (client: 'app' | 'browser',) => {




  return `/_allauth/${client}/v1/auth/webauthn/login`
}
 ...
 */
export const getAllauthClientV1AuthWebauthnLogin = async (client: 'app' | 'browser', options?: RequestInit): Promise<getAllauthClientV1AuthWebauthnLoginResponse> => {

  return authInstance<getAllauthClientV1AuthWebauthnLoginResponse>(getGetAllauthClientV1AuthWebauthnLoginUrl(client),
  {
    ...options,
    method: 'GET'
...
export const getGetAllauthClientV1AuthWebauthnLoginQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthWebauthnLoginQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>> = ({ signal }) => getAllauthClientV1AuthWebauthnLogin(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthWebauthnLogin<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError = ErrorType<unknown>>(
...
export function useGetAllauthClientV1AuthWebauthnLogin<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthWebauthnLogin>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get WebAuthn credential request options for login
...
export type postAllauthClientV1AuthWebauthnLoginResponse200 = {
  data: AuthenticatedResponse
  status: 200
}

export type postAllauthClientV1AuthWebauthnLoginResponse400 = {
  data: ErrorResponse
  status: 400
}

export type postAllauthClientV1AuthWebauthnLoginResponse401 = {
  data: AuthenticationResponse
  status: 401
}

export type postAllauthClientV1AuthWebauthnLoginResponseSuccess = (postAllauthClientV1AuthWebauthnLoginResponse200) & {
  headers: Headers;
};
export type postAllauthClientV1AuthWebauthnLoginResponseError = (postAllauthClientV1AuthWebauthnLoginResponse400 | postAllauthClientV1AuthWebauthnLoginResponse401) & {
  headers: Headers;
};

export type postAllauthClientV1AuthWebauthnLoginResponse = (postAllauthClientV1AuthWebauthnLoginResponseSuccess | postAllauthClientV1AuthWebauthnLoginResponseError)

export const getPostAllauthClientV1AuthWebauthnLoginUrl = (client: 'app' | 'browser',) => {
 ...
 */
export const postAllauthClientV1AuthWebauthnLogin = async (client: 'app' | 'browser',
    loginWebAuthnBody: LoginWebAuthnBody, options?: RequestInit): Promise<postAllauthClientV1AuthWebauthnLoginResponse> => {

  return authInstance<postAllauthClientV1AuthWebauthnLoginResponse>(getPostAllauthClientV1AuthWebauthnLoginUrl(client),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(loginWebAuthnBody)
  }
);}
...
export const getPostAllauthClientV1AuthWebauthnLoginMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnLogin>>, TError,{client: 'app' | 'browser';data: BodyType<LoginWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnLogin>>, TError,{client: 'app' | 'browser';data: BodyType<LoginWebAuthnBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnLogin>>, {client: 'app' | 'browser';data: BodyType<LoginWebAuthnBody>}> = (props) => {
          const {client,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthWebauthnLoginMutationError = ErrorType<ErrorResponse | AuthenticationResponse>

    /**
 * @summary Login using WebAuthn
 */
export const usePostAllauthClientV1AuthWebauthnLogin = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthWebauthnLogin>>, TError,{client: 'app' | 'browser';data: BodyType<LoginWebAuthnBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthWebauthnLoginMutationOptions(options), queryClient);
    }
