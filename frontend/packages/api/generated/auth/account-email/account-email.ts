...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AccountEmailQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AccountEmail>>> = ({ signal }) => getAllauthClientV1AccountEmail(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountEmail>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AccountEmail<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountEmail>>, TError = ErrorType<AuthenticationResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountEmail>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List email addresses
...
export const getPostAllauthClientV1AccountEmailMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountEmail>>, TError,{client: 'app' | 'browser';data?: BodyType<EmailBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AccountEmailMutationBody = BodyType<EmailBody> | undefined
...
export const getPutAllauthClientV1AccountEmailMutationOptions = <TError = ErrorType<ErrorResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putAllauthClientV1AccountEmail>>, TError,{client: 'app' | 'browser';data?: BodyType<EmailBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PutAllauthClientV1AccountEmailMutationBody = BodyType<EmailBody> | undefined
...
export const getPatchAllauthClientV1AccountEmailMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchAllauthClientV1AccountEmail>>, TError,{client: 'app' | 'browser';data?: BodyType<MarkPrimaryEmailBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PatchAllauthClientV1AccountEmailMutationBody = BodyType<MarkPrimaryEmailBody> | undefined
...
export const getDeleteAllauthClientV1AccountEmailMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AccountEmail>>, TError,{client: 'app' | 'browser';data?: BodyType<EmailBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteAllauthClientV1AccountEmailMutationBody = BodyType<EmailBody> | undefined
