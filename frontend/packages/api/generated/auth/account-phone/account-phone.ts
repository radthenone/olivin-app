...
export const getGetAllauthClientV1AccountPhoneQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError = ErrorType<AuthenticationResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AccountPhoneQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>> = ({ signal }) => getAllauthClientV1AccountPhone(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AccountPhone<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError = ErrorType<AuthenticationResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get the phone number
...
export const getPostAllauthClientV1AccountPhoneMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPhone>>, TError,{client: 'app' | 'browser';data?: BodyType<PhoneBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AccountPhoneMutationBody = BodyType<PhoneBody> | undefined
...
export const usePostAllauthClientV1AccountPhone = <TError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AccountPhoneMutationOptions(options), queryClient);
    }
