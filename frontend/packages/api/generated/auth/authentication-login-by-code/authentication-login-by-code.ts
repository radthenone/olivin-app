...
export const postAllauthClientV1AuthCodeRequest = async (client: 'app' | 'browser',
  ...
  return authInstance<postAllauthClientV1AuthCodeRequestResponse>(getPostAllauthClientV1AuthCodeRequestUrl(client),
  {
    ...
    body: JSON.stringify(requestLoginCodeBody)
  }
);}
...
export const getPostAllauthClientV1AuthCodeRequestMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeRequest>>, TError,{client: 'app' | 'browser';data: BodyType<RequestLoginCodeBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const getPostAllauthClientV1AuthCodeConfirmMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeConfirm>>, TError,{client: 'app' | 'browser';data: BodyType<ConfirmLoginCodeBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const usePostAllauthClientV1AuthCodeConfirm = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ConflictResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export type postAllauthClientV1AuthCodeResendResponse200 = {
  data: StatusOKResponse
  status: 200
}

export type postAllauthClientV1AuthCodeResendResponse409 = {
  data: ConflictResponse
  status: 409
}

export type postAllauthClientV1AuthCodeResendResponse429 = {
  data: TooManyRequestsResponse
  status: 429
}

export type postAllauthClientV1AuthCodeResendResponseSuccess = (postAllauthClientV1AuthCodeResendResponse200) & {
  headers: Headers;
};
export type postAllauthClientV1AuthCodeResendResponseError = (postAllauthClientV1AuthCodeResendResponse409 | postAllauthClientV1AuthCodeResendResponse429) & {
  headers: Headers;
};

export type postAllauthClientV1AuthCodeResendResponse = (postAllauthClientV1AuthCodeResendResponseSuccess | postAllauthClientV1AuthCodeResendResponseError)

export const getPostAllauthClientV1AuthCodeResendUrl = (client: 'app' | 'browser',) => {




  return `/_allauth/${client}/v1/auth/code/resend`
}
 ...
 */
export const postAllauthClientV1AuthCodeResend = async (client: 'app' | 'browser', options?: RequestInit): Promise<postAllauthClientV1AuthCodeResendResponse> => {

  return authInstance<postAllauthClientV1AuthCodeResendResponse>(getPostAllauthClientV1AuthCodeResendUrl(client),
  {
    ...options,
    method: 'POST'
...
export const getPostAllauthClientV1AuthCodeResendMutationOptions = <TError = ErrorType<ConflictResponse | TooManyRequestsResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>, TError,{client: 'app' | 'browser'}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>, TError,{client: 'app' | 'browser'}, TContext> => {

const mutationKey = ['postAllauthClientV1AuthCodeResend'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>, {client: 'app' | 'browser'}> = (props) => {
          const {client} = props ?? {};

          return  postAllauthClientV1AuthCodeResend(client,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthCodeResendMutationResult = NonNullable<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>>

    export type PostAllauthClientV1AuthCodeResendMutationError = ErrorType<ConflictResponse | TooManyRequestsResponse>

    /**
 * @summary Resend login code
 */
export const usePostAllauthClientV1AuthCodeResend = <TError = ErrorType<ConflictResponse | TooManyRequestsResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>, TError,{client: 'app' | 'browser'}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof postAllauthClientV1AuthCodeResend>>,
        TError,
        {client: 'app' | 'browser'},
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AuthCodeResendMutationOptions(options), queryClient);
    }
