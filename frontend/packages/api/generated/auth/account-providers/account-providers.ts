...
export const getGetAllauthClientV1AccountProvidersQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AccountProvidersQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>> = ({ signal }) => getAllauthClientV1AccountProviders(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AccountProviders<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List the connected third-party provider accounts
...
export const getDeleteAllauthClientV1AccountProvidersMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>, TError,{client: 'app' | 'browser';data?: BodyType<ProviderAccountBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteAllauthClientV1AccountProvidersMutationBody = BodyType<ProviderAccountBody> | undefined
...
export const useDeleteAllauthClientV1AccountProviders = <TError = ErrorType<ErrorResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteAllauthClientV1AccountProvidersMutationOptions(options), queryClient);
    }
