...
export const getPostAllauthClientV1AuthPasswordRequestMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthPasswordRequest>>, TError,{client: 'app' | 'browser';data: BodyType<RequestPasswordBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
export const getGetAllauthClientV1AuthPasswordResetQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>, TError = ErrorType<ErrorResponse | ConflictResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthPasswordResetQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>> = ({ signal }) => getAllauthClientV1AuthPasswordReset(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1AuthPasswordReset<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>, TError = ErrorType<ErrorResponse | ConflictResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthPasswordReset>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get password reset information
...
export const getPostAllauthClientV1AuthPasswordResetMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthPasswordReset>>, TError,{client: 'app' | 'browser';data?: BodyType<ResetPasswordBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthPasswordResetMutationBody = BodyType<ResetPasswordBody> | undefined
