...
export const getPostAllauthAppV1TokensRefreshMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthAppV1TokensRefresh>>, TError,{data?: BodyType<RefreshTokenBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthAppV1TokensRefresh>>, TError,{data?: BodyType<RefreshTokenBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthAppV1TokensRefresh>>, {data?: BodyType<RefreshTokenBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthAppV1TokensRefreshMutationResult = NonNullable<Awaited<ReturnType<typeof postAllauthAppV1TokensRefresh>>>
    export type PostAllauthAppV1TokensRefreshMutationBody = BodyType<RefreshTokenBody> | undefined
 ...
 */
export const usePostAllauthAppV1TokensRefresh = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthAppV1TokensRefresh>>, TError,{data?: BodyType<RefreshTokenBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthAppV1TokensRefreshMutationOptions(options), queryClient);
    }
