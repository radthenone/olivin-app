...
export const getGetAllauthClientV1ConfigQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1ConfigQueryKey(client);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAllauthClientV1Config>>> = ({ signal }) => getAllauthClientV1Config(client, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: client !== null && client !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetAllauthClientV1Config<TData = Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError, TData>>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get configuration
