...
export const getPostAllauthClientV1Auth2faAuthenticateMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, {client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1Auth2faAuthenticateMutationError = ErrorType<ErrorResponse | AuthenticationResponse>

    /**
 * @summary Two-factor authentication
 */
export const usePostAllauthClientV1Auth2faAuthenticate = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1Auth2faAuthenticateMutationOptions(options), queryClient);
    }
...
export const getPostAllauthClientV1Auth2faReauthenticateMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, {client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}> = (props) => {
          const {client,data} = props ?? {};
 ...
 * @summary Reauthenticate using 2FA
 */
export const usePostAllauthClientV1Auth2faReauthenticate = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1Auth2faReauthenticateMutationOptions(options), queryClient);
    }
