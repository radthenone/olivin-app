...
export const getPostAllauthClientV1AccountPasswordChangeMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPasswordChange>>, TError,{client: 'app' | 'browser';data?: BodyType<ChangePasswordBody>}, TContext>, request?: SecondParameter<typeof authInstance>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AccountPasswordChangeMutationBody = BodyType<ChangePasswordBody> | undefined
...
export const usePostAllauthClientV1AccountPasswordChange = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostAllauthClientV1AccountPasswordChangeMutationOptions(options), queryClient);
    }
