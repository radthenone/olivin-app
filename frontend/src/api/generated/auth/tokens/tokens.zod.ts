 ...
 */
export const PostAllauthAppV1TokensRefreshBody = zod.object({
  "refresh_token": zod.string().describe('The refresh token.\n')
})

export const PostAllauthAppV1TokensRefreshResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.object({
  "access_token": zod.string().describe('The access token.\n'),
  "refresh_token": zod.string().optional().describe('The refresh token.\n')
})
})
