...
export const getPostAllauthClientV1Auth2faAuthenticateMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, }
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1Auth2faAuthenticate>>, {client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}> = (props) => {
          ...
          return  postAllauthClientV1Auth2faAuthenticate(client,data,)
        }
...
export const getPostAllauthClientV1Auth2faReauthenticateMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, TError,{client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}, TContext>, }
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1Auth2faReauthenticate>>, {client: 'app' | 'browser';data: BodyType<MFAAuthenticateBody>}> = (props) => {
          ...
          return  postAllauthClientV1Auth2faReauthenticate(client,data,)
        }
