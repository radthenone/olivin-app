 ...
 */
export const PostAllauthClientV1Auth2faAuthenticateParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const PostAllauthClientV1Auth2faAuthenticateHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const PostAllauthClientV1Auth2faAuthenticateBody = zod.object({
  "code": zod.string().describe('An authenticator code.\n')
})

export const PostAllauthClientV1Auth2faAuthenticateResponse = zod.object({
 ...
 */
export const PostAllauthClientV1Auth2faReauthenticateParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const PostAllauthClientV1Auth2faReauthenticateHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const PostAllauthClientV1Auth2faReauthenticateBody = zod.object({
  "code": zod.string().describe('An authenticator code.\n')
})

export const PostAllauthClientV1Auth2faReauthenticateResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.object({
  "user": zod.object({
  "id": zod.number().optional().describe('The user ID.'),
