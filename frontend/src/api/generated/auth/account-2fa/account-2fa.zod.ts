 ...
 */
export const GetAllauthClientV1AccountAuthenticatorsParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const GetAllauthClientV1AccountAuthenticatorsHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const GetAllauthClientV1AccountAuthenticatorsResponse = zod.object({
  ...
  "type": zod.enum(['recovery_codes']).describe('The authenticator type.\n'),
  "total_code_count": zod.number().describe('The total number of recovery codes that initially were available.\n'),
  "unused_code_count": zod.number().describe('The number of recovery codes that are unused.\n')
})),zod.object({
  "last_used_at": zod.number().nullable().describe('An epoch based timestamp (trivial to parse using: `new Date(value)\*1000`)\n'),
  "created_at": zod.number().describe('An epoch based timestamp (trivial to parse using: `new Date(value)\*1000`)\n')
}).and(zod.object({
 ...
 */
export const GetAllauthClientV1AccountAuthenticatorsTotpParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const GetAllauthClientV1AccountAuthenticatorsTotpHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const GetAllauthClientV1AccountAuthenticatorsTotpResponse = zod.object({
  "status": zod.literal(200),
  "meta": zod.object({
 ...
 */
export const PostAllauthClientV1AccountAuthenticatorsTotpParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const PostAllauthClientV1AccountAuthenticatorsTotpHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const PostAllauthClientV1AccountAuthenticatorsTotpBody = zod.object({
  "code": zod.string().describe('An authenticator code.\n')
})

export const PostAllauthClientV1AccountAuthenticatorsTotpResponse = zod.object({
  "status": zod.literal(200),
  "meta": zod.object({
  "recovery_codes_generated": zod.boolean().optional().describe('Whether or not recovery codes where generated automatically.')
}).optional(),
 ...
 */
export const DeleteAllauthClientV1AccountAuthenticatorsTotpParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const DeleteAllauthClientV1AccountAuthenticatorsTotpHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const DeleteAllauthClientV1AccountAuthenticatorsTotpResponse = zod.object({
  "status": zod.literal(200)
})
 ...
 */
export const GetAllauthClientV1AccountAuthenticatorsRecoveryCodesParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const GetAllauthClientV1AccountAuthenticatorsRecoveryCodesHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const GetAllauthClientV1AccountAuthenticatorsRecoveryCodesResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.object({
  "last_used_at": zod.number().nullable().describe('An epoch based timestamp (trivial to parse using: `new Date(value)\*1000`)\n'),
  "created_at": zod.number().describe('An epoch based timestamp (trivial to parse using: `new Date(value)\*1000`)\n')
  ...
  "unused_codes": zod.array(zod.string().describe('An authenticator code.\n')).describe('The list of unused codes.\n')
}))
})
 ...
 */
export const PostAllauthClientV1AccountAuthenticatorsRecoveryCodesParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const PostAllauthClientV1AccountAuthenticatorsRecoveryCodesHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})
